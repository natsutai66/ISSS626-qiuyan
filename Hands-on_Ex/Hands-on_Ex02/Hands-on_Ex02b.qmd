...
# Helper to parse KML <Description>
...
# Remove offshore groups (same as exercises)
mpsz_cl <- mpsz_sf %>%
  dplyr::filter(
...
# 4) Clip to Singapore window
sg_owin        <- spatstat.geom::as.owin(mpsz_cl)
childcareSG_ppp <- childcare_ppp[sg_owin]

# 5) Planning-area subsets (subset AFTER clip & de-dup)
